export class RegistroSegmentoQ {
    ...
    constructor(templateSegmentoQ) {
        ...
        this.#Pagador          = new DadosPagador(  templateSegmentoQ.dadosPagador.tipoDeInscricao, 
        ...
        this.#Correspondente   = new BancoCorrespondente(   templateSegmentoQ.bancoCorrespondente,
                                                            templateSegmentoQ.nossoNumeroBancoCorrespondente).Conteudo

        this.#Cnab             = new Cnab(  templateSegmentoQ.usoExclusivoCnabFebraban2).Conteudo
    }
    get RegistroSegmentoQ() {
        return this.#Controle + this.#Servico + this.#Pagador + this.#SacadorAvalista + this.#Correspondente + this.#Cnab
    }
}
class Controle {
    #Conteudo = null;
